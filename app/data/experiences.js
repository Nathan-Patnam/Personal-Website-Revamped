export default {
    data: [
...

        {
            ...
            achievements: [
                'Developed 5 web forms in .NET using HTML, CSS, JavaScript, jQuery, Git, VB, and MySQL using Microsoft SQL server.',
                'Increased branch coverage with better unit tests.',
                'Used Ektron, a CMS, to make updates on Wofford’s websites.'
            ],
            viewWork: 'google.com',
            tech: [
                '.NET',
